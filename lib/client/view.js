...
const last       = require("es5-ext/lib/Array/prototype/last")
    ...
    , lcSort     = call.bind(require("es5-ext/lib/String/prototype/case-insensitive-compare"))
	...
	domjs.build(() => {
		...
		section(
			...
			ul(
				...
				mapToArray(
					data,
					function self(value, key, context) {
						let el, len;
						if (isArray(value)) {
							el = li(
								{ class: "feed" },
		...
		container.onscroll = function () {
			let index = -1, pos = container.scrollTop;
